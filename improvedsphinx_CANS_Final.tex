...
\section{Introduction}\label{sec:intro}
    ...
    The LIONESS blockcipher is proven to be secure, under the assumption that the underlying primitives SEAL and SHA-1 are sufficiently secure~\cite{DBLP:conf/fse/AndersonB96a}, therewith making it particularly useful for Sphinx because of its goal to achieve provable security. However, LIONESS dates back to 1996, and has been outpaced by reality. Attacks on SEAL~\cite{DBLP:conf/fse/Fluhrer01a} and SHA-1~\cite{DBLP:conf/eurocrypt/StevensKP16}, the most recent result being a free-start collision attack on the full SHA-1, shine a negative light on the security of the LIONESS mode.
